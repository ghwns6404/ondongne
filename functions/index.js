...
2. 상세 설명:
   - 최소 3문장 이상, **가능하면 200자 이상 400자 이하**로 자세히 작성합니다.
   - 반드시 포함해야 할 내용:
     * 상품의 상태 (사용감, 깨끗함/기스 여부, 새상품/중고 여부 추정)
     * 특징 (브랜드, 모델명, 색상, 용량/사이즈 등 사진에서 보이는 정보)
     * 사용 용도 또는 어울리는 사람 (예: 자취생, 학생, 사무용 등)
     * 하자나 주의사항이 사진상 보인다면 구체적으로 언급
   - 마치 실제 판매자가 쓰는 중고거래 글처럼 자연스럽고 구체적으로 작성하세요.
